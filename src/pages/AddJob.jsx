...
const AddJob = ({ addJobSubmit }) => {
  ...
  const [salary, setSalary] = useState("Under ₹100k");
  ...
  const submitForm = (e) => {
    ...
    addJobSubmit(newJob);
    toast.success("Jobs Access Successfully");
        ...
        <div className="container m-auto max-w-2xl py-24">
          <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
            <form onSubmit={submitForm}>
              ...
              <div>
                <button
                  className="bg-orange-500 hover:bg-orange-400 shadow-xl text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
                  type="submit"
                >
                  Add Job
                </button>
